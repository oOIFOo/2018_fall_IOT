...
//////////////////////////////////////////////////////////////////////////////////////////////////    
    for (let i = 0; i < profile.odf_list.length; i++) {
        odf_name_sec = profile.odf_list[i][1].name;
            if(odf_name_sec[odf_name.length-2] == '_'){
                odf_name_sec = odf_name_sec.substr(0, odf_name_sec.length-2) + '-' + odf_name_sec.substr(odf_name_sec.length-1);
            }		
            odf_func[odf_name_sec] = profile.odf_list[i][1];
            profile.odf_list[i][1] = odf_name_sec;
        }
///////////////////////////////////////////////////////////////////////////////////
