 ...
 $(function(){
        ...
        function moves1(data){
            xx_t=Math.cos((data[0]-90)*Math.PI/180)*velocity;
			yy_t=Math.sin((data[0]-90)*Math.PI/180)*velocity;
	    }
        function moves2(data){
            xxx_t=Math.cos((data[0]-90)*Math.PI/180)*velocity;
			yyy_t=Math.sin((data[0]-90)*Math.PI/180)*velocity;
        }
	    function update1(){
			while(1)
			{
